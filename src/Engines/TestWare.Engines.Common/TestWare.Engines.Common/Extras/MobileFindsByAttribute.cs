...
/// </para>
/// </remarks>
public class MobileFindsByAttribute : AbstractFindsByAttribute
{
    protected By? finder;

    public MobileFindsByAttribute() { }
    ...
    public MobileFindsByAttribute(MobileHow how, string @using)
    {
        How = how;
        Using = @using;
    }
    ...
    /// </summary>
    [DefaultValue(MobileHow.Id)]
    public MobileHow How { get; set; }
    ...
    public override By Finder
    {
        get
        {
            if (this.finder == null)
            {
                this.finder = MobileByFactory.From(this);
            }
